...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-orange-50 p-4">
      <div className="text-center bg-white/80 backdrop-blur-sm p-10 rounded-lg shadow-xl border">
        <h1 className="text-5xl font-bold text-red-600 mb-4">🍜 Pujasera Rush 🍜</h1>
